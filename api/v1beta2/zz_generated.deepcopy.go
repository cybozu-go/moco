...
func (in *MySQLClusterSpec) DeepCopyInto(out *MySQLClusterSpec) {
	*out = *in
	...
	if in.SlowQueryLogConfigTmpl != nil {
		in, out := &in.SlowQueryLogConfigTmpl, &out.SlowQueryLogConfigTmpl
		*out = new(string)
		**out = **in
	}
}
...
func (in *MySQLClusterStatus) DeepCopyInto(out *MySQLClusterStatus) {
	*out = *in
	...
	out.SystemUserRotation = in.SystemUserRotation
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SystemUserRotationStatus) DeepCopyInto(out *SystemUserRotationStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SystemUserRotationStatus.
func (in *SystemUserRotationStatus) DeepCopy() *SystemUserRotationStatus {
	if in == nil {
		return nil
	}
	out := new(SystemUserRotationStatus)
	in.DeepCopyInto(out)
	return out
}
