...
var _ admission.Validator[*BackupPolicy] = &backupPolicyAdmission{}

func (a *backupPolicyAdmission) ValidateCreate(ctx context.Context, policy *BackupPolicy) (admission.Warnings, error) {
...
func (a *backupPolicyAdmission) ValidateUpdate(ctx context.Context, _ *BackupPolicy, newPolicy *BackupPolicy) (admission.Warnings, error) {
	return a.ValidateCreate(ctx, newPolicy)
}

func (a *backupPolicyAdmission) ValidateDelete(ctx context.Context, policy *BackupPolicy) (admission.Warnings, error) {
