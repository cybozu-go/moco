...
import (
	...
	mococybozucomv1beta1 "github.com/cybozu-go/moco/api/v1beta1"
...
func init() {
	...
	utilruntime.Must(mococybozucomv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c1cc1040.cybozu.com",
	})
	if err != nil {
	...
	if err = (&mococybozucomv1beta1.MySQLCluster{}).SetupWebhookWithManager(mgr); err != nil {
