...
// 				opts := cmp.Options{cmpopts.IgnoreFields(mocov1beta1.MySQLClusterCondition{}, "LastTransitionTime"), cmpopts.IgnoreInterfaces(struct{ ops.Operator }{})}
...
// 	ClusterResource *mocov1beta1.MySQLCluster
// 	ClusterStatus   *accessor.MySQLClusterStatus
// }

// func cluster(primary *int) *mocov1beta1.MySQLCluster {
...
// func intermediate(c *mocov1beta1.MySQLCluster) *mocov1beta1.MySQLCluster {
// 	secret := "dummy-secret"
...
// // Functions to generate mocov1beta1.MySQLClusterCondition

// func violation(s bool, message string) mocov1beta1.MySQLClusterCondition {
// 	return mocov1beta1.MySQLClusterCondition{
...
// func available(s bool, message string) mocov1beta1.MySQLClusterCondition {
// 	return mocov1beta1.MySQLClusterCondition{
...
// func failure(s bool, message string) mocov1beta1.MySQLClusterCondition {
// 	return mocov1beta1.MySQLClusterCondition{
...
// func healthy(s bool, message string) mocov1beta1.MySQLClusterCondition {
// 	return mocov1beta1.MySQLClusterCondition{
...
// func outOfSync(s bool, message string) mocov1beta1.MySQLClusterCondition {
// 	return mocov1beta1.MySQLClusterCondition{
...
// func assertConditions(expected, actual []mocov1beta1.MySQLClusterCondition) bool {
// 	if len(expected) != len(actual) {
// 		return false
// 	}
...
// func equalCondition(cond1, cond2 mocov1beta1.MySQLClusterCondition) bool {
...
// type Conditions []mocov1beta1.MySQLClusterCondition
